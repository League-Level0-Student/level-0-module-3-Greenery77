...
public class ShinyObjects {
	...
	void manyShinyObjects() {
		...
		String shinyObjectAmount = JOptionPane.showInputDialog("How many shiny objects do you want?");
		
		// 3. Play the sound that many times

		int shinyObjectNumber = Integer.parseInt(shinyObjectAmount);
		
		for (int i = 0; i < shinyObjectNumber; i++) {
